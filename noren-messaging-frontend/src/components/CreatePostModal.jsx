...
export default function CreatePostModal({ onClose, onPostCreated }) {
  ...
  return (
    <div className="fixed inset-0 z-50 bg-black/85 backdrop-blur-md flex items-center justify-center p-4">
      <div className="w-full max-w-lg glass-panel rounded-3xl p-6 border border-white/20 shadow-2xl">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            <label className="block text-xs font-semibold text-neutral-300 mb-1">Media Type</label>
          ...
          <div>
            <label className="block text-xs font-semibold text-neutral-300 mb-1">Media URL</label>
            <input
              type="text"
