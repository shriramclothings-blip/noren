        ...
        <div style={{ background: '#faf9f7', border: '1px solid #e6e0d8', padding: '40px 40px 36px' }}>
          ...
          <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: 18 }}>
            ...
            <div>
              ...
              <input type="email" required value={form.email} onChange={set('email')} placeholder="your@email.com" className="input" />
            </div>
            <div>
            ...
            <button type="submit" disabled={loading} className="btn-primary"
              style={{ width: '100%', padding: '14px', fontSize: 11, marginTop: 4 }}>
